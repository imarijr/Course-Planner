...
var argv = yargs.argv,
    root = 'src/',
    dist = 'dist',
    styles = root + 'style.css',
    scripts = root + 'app/**/*.js',
    developmentServerURL = '',
    productionServerURL = '',
    templates = ['src/app/**/*.html'],
    modules = ['angular-ui-sortable/src/sortable.js',
...
gulp.task('copy-semester-data', function() {
    return gulp
        .src('src/app/components/semesters/data.json')
        .pipe(gulp.dest(dist));
})

gulp.task('copy-class-data', function() {
    return gulp
        .src('src/app/components/addclass/addClass.json')
        .pipe(gulp.dest(dist));
})
...
gulp.task('default', ['clean'], function (callback) {
    runSequence('scripts', 'styles', 'copy-html', 'copy-semester-data', 'copy-class-data', 'copy-img', 'copy-fonts', 'connect-app', 'watch', callback);
});

gulp.task('production', ['clean'], function (callback) {
    runSequence('scripts', 'styles', 'copy-html', 'copy-semester-data', 'copy-class-data', 'copy-img', 'copy-fonts', callback);
});
